      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">Tableaux League</a>
          </div>
            ...
            <div class="col">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Touts les leagues</h4>
                  <p class="card-category">Liste complète des leagues</p>
                </div>
                <div class="card-body table-responsive">
                  <table class="table table-hover" id="league-tableau">
                    ...
                    <tbody>
                      @foreach ($dash->GetAllLeagues() as $user)
                      <tr>
                        <td class="league_id">{{$user->id}}</td>
                        <td>{{$user->name}}</td>
                        <td>{{$user->owner}}</td>
                        <td>{{$user->max}}</td>
                        <td class="float-right">
                          <button type="button" class="btn btn-danger delete-league">Supprimer</button>
