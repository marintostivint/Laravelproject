        ...
        <div class="row justify-content-md-center">
          <div class="signup-form col col-lg-5">
            ...
            @csrf
                ...
                <div class="form-group">
        			<label class="checkbox-inline"><input type="checkbox" name="check" > I accept the <a href="#">Terms of Use</a> &amp; <a href="#">Privacy Policy</a></label>
        		</div>
            @if (session('erreur'))
                <label style="color:red"><i class="fas fa-exclamation-triangle" style="color:red"></i>{{session('erreur')}}</label>
            @endif
        		<div class="form-group">
        	...
        	<div class="hint-text">Vous n'avez pas de compte ? <a href="/inscription">vers ici</a></div>
        </div>
       </div>
      </div>
    </body>
